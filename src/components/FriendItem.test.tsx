...
test('friend row section renders', () => {    
  const friendInfoRowComponent = render(<FriendItem {...testFriend} />,{wrapper: BrowserRouter});
  const rowSection = friendInfoRowComponent.container.querySelector('.FriendRow'); 
  expect(rowSection).toBeInTheDocument();
});